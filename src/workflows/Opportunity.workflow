...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <alerts>
        <fullName>Events_Won_Opp_Alert</fullName>
        ...
        <senderType>OrgWideEmailAddress</senderType>
        <template>unfiled$public/Closed_Won_Event_Email</template>
    </alerts>
    <alerts>
    ...
    <alerts>
        ...
        <recipients>
            <recipient>EU_VP_Sales</recipient>
            <type>role</type>
        </recipients>
        <recipients>
            <recipient>UK_Associate_Sales_Manager</recipient>
    ...
    <alerts>
        <fullName>Won_Opp_Advertising</fullName>
        <description>Won Opp Advertising</description>
        <protected>false</protected>
        <recipients>
            <recipient>BDR</recipient>
            <type>role</type>
        ...
        <recipients>
            <recipient>ggatto@greenstreet.com</recipient>
            <type>user</type>
        </recipients>
        <recipients>
        ...
        <recipients>
            <recipient>rkoslow@greenstreet.com</recipient>
            <type>user</type>
        </recipients>
        <recipients>
            <recipient>sayala@greenstreet.com</recipient>
        ...
        <senderAddress>greenstreet-newbusinesssales@greenstreetadvisors.com</senderAddress>
        <senderType>OrgWideEmailAddress</senderType>
        <template>unfiled$public/Closed_Won_Advertising_Email</template>
    </alerts>
    <alerts>
    ...
    <alerts>
        <fullName>Won_Opp_alert_to_New_Sales_with_ICP</fullName>
        <description>Won Opp alert to New Sales with ICP</description>
        <protected>false</protected>
        <recipients>
            <recipient>BDR</recipient>
            <type>role</type>
        ...
        <senderAddress>greenstreet-newbusinesssales@greenstreetadvisors.com</senderAddress>
        <senderType>OrgWideEmailAddress</senderType>
        <template>unfiled$public/Closed_Won_Alert_with_ICP</template>
    </alerts>
    <alerts>
